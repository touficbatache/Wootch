...
public class LoadingDetailDialogFragment extends DialogFragment {
  ...
  public static com.batache.wootch.app.base.LoadingDetailDialogFragment newInstance(Integer position) {
    com.batache.wootch.app.base.LoadingDetailDialogFragment frag = new com.batache.wootch.app.base.LoadingDetailDialogFragment();
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    return LayoutInflater.from(new ContextThemeWrapper(getActivity(), R.style.Theme_Wootch)).inflate(R.layout
