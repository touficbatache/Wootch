...
import com.batache.wootch.ui.view.ButterSeekBar;
...
public class BeamPlayerFragment extends Fragment implements TorrentServerListener {
  ...
  public void onActivityCreated(@Nullable Bundle savedInstanceState) {
    ...
    if (paletteColor == -1) {
      paletteColor = getResources().getColor(R.color.colorPrimary);
    }

    LayerDrawable progressDrawable = (LayerDrawable) getResources().getDrawable(R.drawable.scrubber_progress_horizontal_bigtrack);
    LayerDrawable volumeDrawable = (LayerDrawable) getResources().getDrawable(R.drawable.scrubber_progress_horizontal);
    ...
    if (mStreamInfo.getImageUrl() != null && !mStreamInfo.getImageUrl().equals("")) {
      Picasso.get().load(mStreamInfo.getHeaderImageUrl())
